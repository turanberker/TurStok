        ...
        public void ThrowExp(Exception exp, Form context, string methodadi)
        {
            ...
            if (CheckConnection())
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Beklenmedik Bir Hata Alınmıştır. Hata Kaydedilmiştir ancak internet bağlantısı olmadığından Mail gönderilememiştir. ", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch
                {
            ...
            {
                MessageBox.Show("Beklenmedik Bir Hata Alınmıştır. Mail Formatları olmadığından Mail Atılamamıştır. ", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
