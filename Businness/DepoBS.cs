...
namespace Businness
{
    public class DepoBS:DisposeEt
    {
        ...
        public bool Update(DepoEntity entity)
        {
            return vek.ExecuteNonQuery(CommandType.Text, "Update Depo set DepoAdi=@b where DepoID=@a ", entity.DepoAdi, entity.DepoID) > 0 ? true : false;
        }
    }
}
